...
export default function AddProjectPanel({ onClose, onSaved }) {
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ backgroundColor: '#1a2b4a', padding: '18px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
          <div>
            <h2 style={{ color: 'white', fontSize: '16px', fontWeight: 'bold', margin: 0 }}>Add New Project</h2>
            <p style={{ color: '#93c5fd', fontSize: '12px', margin: 0 }}>Liberty Integrated Solutions</p>
          </div>
          <button
            onClick={onClose}
